...
# Write some minimal ELF binary files. By doing so, this script will show the
# necessary pieces of an ELF binary, exercising different features of the ELF
# format.
...
## ELF HEADER #################################################################
  ...
  f.b 0xf8, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Entry point
  f.b 0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Prog. header tbl start
  ...
  f.b 0x02, 0x00 # Sect. header number of entries
  f.b 0x01, 0x00 # Index of section name string table in section headers
...
## SECTION HEADERS TABLE ######################################################
  ...
  f.b 0xf8, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Address
  f.b 0xf8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Offset
  ...
  f.b 0x06, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Offset
...
## PROGRAM HEADERS TABLE ######################################################
  ...
  f.b 0xf8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Section offset in file
  f.b 0xf8, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Virt. addr. in mem.
  f.b 0xf8, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Phys. addr. in mem.
...
write_bytes('from-scratch-write') do |f|
...
## ELF HEADER #################################################################
  ...
  f.b 0x70, 0x01, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Entry point
  ...
  f.b 0x40, 0x00 # Header size in bytes
  f.b 0x38, 0x00 # Prog. header entry size in bytes - 56 bytes for 64-bit arch
  f.b 0x02, 0x00 # Prog. header number of entries
  f.b 0x40, 0x00 # Sect. header entry size in bytes
...
## SECTION HEADERS TABLE ######################################################
  ...
  f.b 0x01, 0x00, 0x00, 0x00 # Type - PROGBITS
  f.b 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Flags - Alloc + exec
  f.b 0x70, 0x01, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Address
  f.b 0x70, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Offset
  f.b 0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Size
  f.b 0x00, 0x00, 0x00, 0x00 # Link - none (static binary)
  f.b 0x00, 0x00, 0x00, 0x00 # Info - none
  f.b 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Address align
  f.b 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Entry size - N/A
  ...
  f.b 0x07, 0x00, 0x00, 0x00 # Name
  f.b 0x01, 0x00, 0x00, 0x00 # Type - PROGBITS
  f.b 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Flags - Alloc + write
  f.b 0x92, 0x01, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00 # Address
  f.b 0x92, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Offset
  f.b 0x0e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Size
  f.b 0x00, 0x00, 0x00, 0x00 # Link - none (static binary)
  f.b 0x00, 0x00, 0x00, 0x00 # Info - none
  f.b 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Address align
  ...
  f.b 0x0d, 0x00, 0x00, 0x00 # Name
  f.b 0x03, 0x00, 0x00, 0x00 # Type - STRTAB
  f.b 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Flags - N/A
  f.b 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Address - N/A
  f.b 0xa0, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Offset
  f.b 0x17, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Size
  f.b 0x00, 0x00, 0x00, 0x00 # Link - none
  f.b 0x00, 0x00, 0x00, 0x00 # Info - none
  f.b 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Address align
  f.b 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Entry size - N/A
...
## PROGRAM HEADERS TABLE ######################################################
  ...
  # Segment 0 - executable code

  f.b 0x01, 0x00, 0x00, 0x00 # Loadable segment
  f.b 0x05, 0x00, 0x00, 0x00 # Read + execute flags
  f.b 0x70, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Section offset in file
  f.b 0x70, 0x01, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Virt. addr. in mem.
  f.b 0x70, 0x01, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Phys. addr. in mem.
  f.b 0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Section size in file
  f.b 0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Section size in mem.
  f.b 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Alignment

  # Segment 1 - data
  f.b 0x01, 0x00, 0x00, 0x00 # Loadable segment
  f.b 0x06, 0x00, 0x00, 0x00 # Read + write flags
  f.b 0x92, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Section offset in file
  f.b 0x92, 0x01, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00 # Virt. addr. in mem.
  f.b 0x92, 0x01, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00 # Phys. addr. in mem.
  f.b 0x0e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Section size in file
  f.b 0x0e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Section size in mem.
  f.b 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Alignment
...
## PROGRAM CODE (.text SECTION) ###############################################
  ...
  # See: http://ref.x86asm.net/coder64.html
  f.b 0xb8, 0x01, 0x00, 0x00, 0x00 # mov  $1, %eax
  f.b 0xbf, 0x01, 0x00, 0x00, 0x00 # mov  $1, %edi
  f.b 0xbe, 0x92, 0x01, 0x80, 0x00 # mov  $0x800192, %esi
  f.b 0xba, 0x0e, 0x00, 0x00, 0x00 # mov  $14, %edx
  f.b 0x0f, 0x05                   # syscall

  f.b 0xb8, 0x3c, 0x00, 0x00, 0x00 # mov  $60, %eax
  f.b 0xbf, 0x2a, 0x00, 0x00, 0x00 # mov  $42, %edi
  f.b 0x0f, 0x05                   # syscall

## R/W DATA (.data SECTION) ###################################################

  f.b 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x2c, 0x20 # "Hello, "
  f.b 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x21, 0x0a # "world!\n"

## SECTION HEADERS STRING TABLE ###############################################

  # The reason for putting this *after* the other sections is because this
  # section is highly variable in size and not well-aligned to word boundaries
  # (being strings and all). Thus, it's nice to not mess up the alignment of
  # other sections, such as the program code, by placing those sections after
  # the string table.

  f.b 0x00
  f.b 0x2e, 0x74, 0x65, 0x78, 0x74, 0x00 # .text
  f.b 0x2e, 0x64, 0x61, 0x74, 0x61, 0x00 # .data
  f.b 0x2e, 0x73, 0x68, 0x73, 0x74, 0x72, 0x74, 0x61, 0x62, 0x00 # .shstrtab
end
