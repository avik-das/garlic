...
# TODO: minimize the size of the binary. Right now, the binary has a ton of
#   padding. Without this padding, the program segfaults, probably due to
#   something to do with alignment. Need to figure out what's going on.
...
## ELF HEADER #################################################################
  ...
  f.b 0x00, 0x10, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Entry point
  f.b 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Prog. header tbl start
  f.b 0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Sect. header tbl offset
...
## PROGRAM HEADERS TABLE ######################################################
  ...
  # TODO - figure out why an offset of 0x138 is not working
  #        probably has to do with alignment?
  f.b 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Section offset in file
  f.b 0x00, 0x10, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Virt. addr. in mem.
  f.b 0x00, 0x10, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Phys. addr. in mem.
...
## SECTION HEADERS TABLE ######################################################
  ...
  f.b 0x00, 0x10, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00 # Address
  # TODO - why can't this be 0x138? See TODO above
  f.b 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Offset
  ...
  # TODO - why can't this be 0x138 + 0xe = 0x146? See TODO above
  f.b 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 # Offset
...
## PADDING ####################################################################
  ...
  # In order to place the code at the right place, need to add a whole bunch of
  # padding! Ideally, this should be minimized.
  f.b(*([0x00] * (0x1000 - (64 + 56 + 64 * 3))))
